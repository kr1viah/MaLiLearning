...
public class InputHandler implements IKeybindProvider, IKeyboardInputHandler, IMouseInputHandler
{
	...
	{
		manager.addHotkeysForCategory(MalilearningClient.MOD_NAME, "tweakeroo.hotkeys.category.disable_toggle_hotkeys", Configs.Disable.OPTIONS);
		manager.addHotkeysForCategory(MalilearningClient.MOD_NAME, "tweakeroo.hotkeys.category.generic_hotkeys", Hotkeys.HOTKEY_LIST);
	}
